  ...
  return (
    <Layout>
      ...
      <div className="iframe__wrapper" id="bookTable">
        ...
        <p>
          Får du inte en bekräftelse, så titta i skräpposten. Den kan ha hamnat
          där.
        </p>
        <div style={{ margin: "10px 0px 25px" }}>
          ...
          <ul style={{ listStyle: "disc", padding: "0px 23px" }}>
            <li>
              Bokade platser = middagsbokning för SAMTLIGA bokade gäster. (Minst
              huvudrätt)
            </li>
            <li>
              Om antalet gäster i din bokning ändras: skicka sms till 0768824549
              och meddela.
            </li>
            <li>
              Enl Coronarestriktionerna måste alla gäster sitta. Vi har plockat
              bort bord och har färre platser än tidigare för att kunna hålla
              avstånd mellan sällskapen. Vi ändrar kontinuerligt för att för att
              följa folkhälsomyndughetens restriktioner och rekommendationer för
